...
const MainComponent = () => {
  ...
  const redirectToAllBuckets = useCallback(async () => {
    window.location.href = '/api/info_all_buckets';
  }, []);

  return (
    <div>
      <button onClick={getJsonData}>Ping</button><br/>
      <button onClick={redirectToAllBuckets}>All Buckets</button><br/>
